...
public class GoldCoin : MonoBehaviour
{
    ...
    public void Initialize(int value)
    {
        ...
        // Le mouvement ne sert à rien tant qu'il est au sol.
        this.enabled = false;
    }
    ...
    private void Collect()
    {
        ...
        {
            GoldManager.Instance.AddGold(_goldValue);
        }

        if (GoldPool.Instance != null)
        {
            GoldPool.Instance.ReturnToPool(this.gameObject);
        }
        else
        {
            Destroy(gameObject);
