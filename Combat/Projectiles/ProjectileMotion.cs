...
public class OrbitMotion : IMotionStrategy
{
    ...
    {
        // NOTE: duration ignorée pour Orbit - ils tournent à l'infini
        _speed = speed;
        _index = index;
        _totalCount = count;
        _radius = radius;
    ...
    public void Update(ProjectileController pc, float dt)
    {
        ...
        // PLUS DE DESPAWN SUR DURÉE - Les Orbit tournent à l'infini
    }

    /// <summary>
    /// Met à jour le nombre total et réindexe ce projectile
    /// </summary>
